  ...
  store : function (e)​ {
    ...
    if (links.length>0) ​{
      if (lib().title=="UroBase" || lib().title=="Backup"​)​ {
        this.a.push(e.field("Date")!=null?e.field("Date").toLocaleString("en-US"):null)​;	       //0
        ...
        this.a.push(e.field("VisitDate")!=null?e.field("VisitDate").toLocaleString("en-US"):null);       //​6
        this.a.push(e.field("DischargeDate")!=null?e.field("DischargeDate").toLocaleString("en-US"):null);   //​7
        this.a.push(e.field("EntryMx"));         //​8
        this.a.push(e.field("AppointDate")!=null?e.field("AppointDate").toLocaleString("en-US"):null​);     //​9
        this.a.push(e.field("Status"));         //​10 
        this.a.push(e.field("DJstent"));        //​11
        this.a.push(e.field("OpExtra"));        //​12
        this.a.push(e.field("Bonus"));          //​13
        this.a.push(e.field("RecordDate")!=null?e.field("RecordDate").toLocaleString("en-US"):null);     //​14
        ...
        this.a.push(e.field("ConsultDate")!=null?e.field("ConsultDate").toLocaleString("en-US"):null);     //0
        this.a.push(links[0].title);             //​1
        this.a.push(e.field("VisitType"));       //​2
        this.a.push(e.field("Ward"));            //​3
        this.a.push(e.field("VisitDate")!=null?e.field("VisitDate").toLocaleString("en-US"):null);       //​4
        this.a.push(e.field("DischargeDate")!=null?e.field("DischargeDate").toLocaleString("en-US"):null);   //​5
        this.a.push(e.field("EntryMx"));         //​6
        this.a.push(e.field("AppointDate")!=null?e.field("AppointDate").toLocaleString("en-US"):null);     //​7
